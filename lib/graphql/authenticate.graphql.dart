...
class Variables$Mutation$LoginWithApple {
  factory Variables$Mutation$LoginWithApple({
    required String token,
    String? email,
    required String firstName,
    required String lastName,
  }) =>
      Variables$Mutation$LoginWithApple._({
        r'token': token,
  ...
  Variables$Mutation$LoginWithApple._(this._$data);

  factory Variables$Mutation$LoginWithApple.fromJson(
      Map<String, dynamic> data) {
    final result$data = <String, dynamic>{};
    final l$token = data['token'];
    result$data['token'] = (l$token as String);
    ...
    final l$lastName = data['lastName'];
    result$data['lastName'] = (l$lastName as String);
    return Variables$Mutation$LoginWithApple._(result$data);
  }
  ...
  CopyWith$Variables$Mutation$LoginWithApple<Variables$Mutation$LoginWithApple>
      get copyWith => CopyWith$Variables$Mutation$LoginWithApple(
            this,
            (i) => i,
          );
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Variables$Mutation$LoginWithApple ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$token = token;
...
abstract class CopyWith$Variables$Mutation$LoginWithApple<TRes> {
  factory CopyWith$Variables$Mutation$LoginWithApple(
    Variables$Mutation$LoginWithApple instance,
    TRes Function(Variables$Mutation$LoginWithApple) then,
  ) = _CopyWithImpl$Variables$Mutation$LoginWithApple;

  factory CopyWith$Variables$Mutation$LoginWithApple.stub(TRes res) =
      _CopyWithStubImpl$Variables$Mutation$LoginWithApple;
...
class _CopyWithImpl$Variables$Mutation$LoginWithApple<TRes>
    implements CopyWith$Variables$Mutation$LoginWithApple<TRes> {
  _CopyWithImpl$Variables$Mutation$LoginWithApple(
    this._instance,
    this._then,
  );

  final Variables$Mutation$LoginWithApple _instance;

  final TRes Function(Variables$Mutation$LoginWithApple) _then;
  ...
  TRes call({
    ...
    Object? lastName = _undefined,
      ...
      _then(Variables$Mutation$LoginWithApple._({
        ..._instance._$data,
        if (token != _undefined && token != null) 'token': (token as String),
...
class _CopyWithStubImpl$Variables$Mutation$LoginWithApple<TRes>
    implements CopyWith$Variables$Mutation$LoginWithApple<TRes> {
  _CopyWithStubImpl$Variables$Mutation$LoginWithApple(this._res);
...
class Mutation$LoginWithApple {
  Mutation$LoginWithApple({
    required this.authenticate,
    this.$__typename = 'Mutation',
  });

  factory Mutation$LoginWithApple.fromJson(Map<String, dynamic> json) {
    final l$authenticate = json['authenticate'];
    final l$$__typename = json['__typename'];
    return Mutation$LoginWithApple(
      authenticate: Mutation$LoginWithApple$authenticate.fromJson(
          (l$authenticate as Map<String, dynamic>)),
      $__typename: (l$$__typename as String),
    );
  }

  final Mutation$LoginWithApple$authenticate authenticate;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$LoginWithApple || runtimeType != other.runtimeType) {
      return false;
    }
    final l$authenticate = authenticate;
    final lOther$authenticate = other.authenticate;
...
extension UtilityExtension$Mutation$LoginWithApple on Mutation$LoginWithApple {
  CopyWith$Mutation$LoginWithApple<Mutation$LoginWithApple> get copyWith =>
      CopyWith$Mutation$LoginWithApple(
        this,
        (i) => i,
      );
}

abstract class CopyWith$Mutation$LoginWithApple<TRes> {
  factory CopyWith$Mutation$LoginWithApple(
    Mutation$LoginWithApple instance,
    TRes Function(Mutation$LoginWithApple) then,
  ) = _CopyWithImpl$Mutation$LoginWithApple;

  factory CopyWith$Mutation$LoginWithApple.stub(TRes res) =
      _CopyWithStubImpl$Mutation$LoginWithApple;

  TRes call({
    Mutation$LoginWithApple$authenticate? authenticate,
    String? $__typename,
  });
  CopyWith$Mutation$LoginWithApple$authenticate<TRes> get authenticate;
}

class _CopyWithImpl$Mutation$LoginWithApple<TRes>
    implements CopyWith$Mutation$LoginWithApple<TRes> {
  _CopyWithImpl$Mutation$LoginWithApple(
    this._instance,
    this._then,
  );

  final Mutation$LoginWithApple _instance;

  final TRes Function(Mutation$LoginWithApple) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$LoginWithApple(
        authenticate: authenticate == _undefined || authenticate == null
            ? _instance.authenticate
            : (authenticate as Mutation$LoginWithApple$authenticate),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
  ...
  CopyWith$Mutation$LoginWithApple$authenticate<TRes> get authenticate {
    final local$authenticate = _instance.authenticate;
    return CopyWith$Mutation$LoginWithApple$authenticate(
        local$authenticate, (e) => call(authenticate: e));
  }
}

class _CopyWithStubImpl$Mutation$LoginWithApple<TRes>
    implements CopyWith$Mutation$LoginWithApple<TRes> {
  _CopyWithStubImpl$Mutation$LoginWithApple(this._res);
  ...
  CopyWith$Mutation$LoginWithApple$authenticate<TRes> get authenticate =>
      CopyWith$Mutation$LoginWithApple$authenticate.stub(_res);
}

const documentNodeMutationLoginWithApple = DocumentNode(definitions: [
  OperationDefinitionNode(
    type: OperationType.mutation,
...
Mutation$LoginWithApple _parserFn$Mutation$LoginWithApple(
        Map<String, dynamic> data) =>
    Mutation$LoginWithApple.fromJson(data);
typedef OnMutationCompleted$Mutation$LoginWithApple = FutureOr<void> Function(
  Map<String, dynamic>?,
  Mutation$LoginWithApple?,
);

class Options$Mutation$LoginWithApple
    extends graphql.MutationOptions<Mutation$LoginWithApple> {
  Options$Mutation$LoginWithApple({
    String? operationName,
    required Variables$Mutation$LoginWithApple variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Mutation$LoginWithApple? typedOptimisticResult,
    graphql.Context? context,
    OnMutationCompleted$Mutation$LoginWithApple? onCompleted,
    graphql.OnMutationUpdate<Mutation$LoginWithApple>? update,
    graphql.OnError? onError,
  })  : onCompletedWithParsed = onCompleted,
        super(
          variables: variables.toJson(),
          ...
          onCompleted: onCompleted == null
              ...
              : (data) => onCompleted(
                    ...
                    data == null
                        ? null
                        : _parserFn$Mutation$LoginWithApple(data),
                  ),
          update: update,
          onError: onError,
          document: documentNodeMutationLoginWithApple,
          parserFn: _parserFn$Mutation$LoginWithApple,
        );

  final OnMutationCompleted$Mutation$LoginWithApple? onCompletedWithParsed;
...
class WatchOptions$Mutation$LoginWithApple
    extends graphql.WatchQueryOptions<Mutation$LoginWithApple> {
  WatchOptions$Mutation$LoginWithApple({
    String? operationName,
    required Variables$Mutation$LoginWithApple variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
extension ClientExtension$Mutation$LoginWithApple on graphql.GraphQLClient {
  Future<graphql.QueryResult<Mutation$LoginWithApple>> mutate$LoginWithApple(
          Options$Mutation$LoginWithApple options) async =>
      await this.mutate(options);
  graphql.ObservableQuery<Mutation$LoginWithApple> watchMutation$LoginWithApple(
          WatchOptions$Mutation$LoginWithApple options) =>
      this.watchMutation(options);
}

class Mutation$LoginWithApple$HookResult {
  Mutation$LoginWithApple$HookResult(
    this.runMutation,
    this.result,
  );

  final RunMutation$Mutation$LoginWithApple runMutation;

  final graphql.QueryResult<Mutation$LoginWithApple> result;
}

Mutation$LoginWithApple$HookResult useMutation$LoginWithApple(
    [WidgetOptions$Mutation$LoginWithApple? options]) {
  final result = graphql_flutter
      .useMutation(options ?? WidgetOptions$Mutation$LoginWithApple());
  return Mutation$LoginWithApple$HookResult(
    (variables, {optimisticResult, typedOptimisticResult}) =>
        result.runMutation(
      variables.toJson(),
      optimisticResult: optimisticResult ?? typedOptimisticResult?.toJson(),
...
graphql.ObservableQuery<Mutation$LoginWithApple>
    useWatchMutation$LoginWithApple(
            WatchOptions$Mutation$LoginWithApple options) =>
        graphql_flutter.useWatchMutation(options);

class WidgetOptions$Mutation$LoginWithApple
    extends graphql.MutationOptions<Mutation$LoginWithApple> {
  WidgetOptions$Mutation$LoginWithApple({
    String? operationName,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
...
typedef RunMutation$Mutation$LoginWithApple
    = graphql.MultiSourceResult<Mutation$LoginWithApple> Function(
  Variables$Mutation$LoginWithApple, {
  Object? optimisticResult,
  Mutation$LoginWithApple? typedOptimisticResult,
});
typedef Builder$Mutation$LoginWithApple = widgets.Widget Function(
  RunMutation$Mutation$LoginWithApple,
  graphql.QueryResult<Mutation$LoginWithApple>?,
);

class Mutation$LoginWithApple$Widget
    extends graphql_flutter.Mutation<Mutation$LoginWithApple> {
  Mutation$LoginWithApple$Widget({
    widgets.Key? key,
    WidgetOptions$Mutation$LoginWithApple? options,
    required Builder$Mutation$LoginWithApple builder,
  }) : super(
          key: key,
          options: options ?? WidgetOptions$Mutation$LoginWithApple(),
          builder: (
            run,
            result,
          ) =>
...
class Mutation$LoginWithApple$authenticate {
  Mutation$LoginWithApple$authenticate({required this.$__typename});

  factory Mutation$LoginWithApple$authenticate.fromJson(
      Map<String, dynamic> json) {
    switch (json["__typename"] as String) {
      case "CurrentUser":
        return Mutation$LoginWithApple$authenticate$$CurrentUser.fromJson(json);

      case "InvalidCredentialsError":
        return Mutation$LoginWithApple$authenticate$$InvalidCredentialsError
            .fromJson(json);

      case "NotVerifiedError":
        return Mutation$LoginWithApple$authenticate$$NotVerifiedError.fromJson(
            json);

      default:
        final l$$__typename = json['__typename'];
        return Mutation$LoginWithApple$authenticate(
            $__typename: (l$$__typename as String));
    }
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$LoginWithApple$authenticate ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$$__typename = $__typename;
...
extension UtilityExtension$Mutation$LoginWithApple$authenticate
    on Mutation$LoginWithApple$authenticate {
  CopyWith$Mutation$LoginWithApple$authenticate<
          Mutation$LoginWithApple$authenticate>
      get copyWith => CopyWith$Mutation$LoginWithApple$authenticate(
            this,
            (i) => i,
          );
  _T when<_T>({
    required _T Function(Mutation$LoginWithApple$authenticate$$CurrentUser)
        currentUser,
    required _T Function(
            Mutation$LoginWithApple$authenticate$$InvalidCredentialsError)
        invalidCredentialsError,
    required _T Function(Mutation$LoginWithApple$authenticate$$NotVerifiedError)
        notVerifiedError,
    required _T Function() orElse,
  }) {
    switch ($__typename) {
      case "CurrentUser":
        return currentUser(
            this as Mutation$LoginWithApple$authenticate$$CurrentUser);

      case "InvalidCredentialsError":
        return invalidCredentialsError(this
            as Mutation$LoginWithApple$authenticate$$InvalidCredentialsError);

      case "NotVerifiedError":
        return notVerifiedError(
            this as Mutation$LoginWithApple$authenticate$$NotVerifiedError);
  ...
  _T maybeWhen<_T>({
    _T Function(Mutation$LoginWithApple$authenticate$$CurrentUser)? currentUser,
    _T Function(Mutation$LoginWithApple$authenticate$$InvalidCredentialsError)?
        invalidCredentialsError,
    _T Function(Mutation$LoginWithApple$authenticate$$NotVerifiedError)?
        notVerifiedError,
    required _T Function() orElse,
  }) {
    switch ($__typename) {
...
abstract class CopyWith$Mutation$LoginWithApple$authenticate<TRes> {
  factory CopyWith$Mutation$LoginWithApple$authenticate(
    Mutation$LoginWithApple$authenticate instance,
    TRes Function(Mutation$LoginWithApple$authenticate) then,
  ) = _CopyWithImpl$Mutation$LoginWithApple$authenticate;

  factory CopyWith$Mutation$LoginWithApple$authenticate.stub(TRes res) =
      _CopyWithStubImpl$Mutation$LoginWithApple$authenticate;

  TRes call({String? $__typename});
}

class _CopyWithImpl$Mutation$LoginWithApple$authenticate<TRes>
    implements CopyWith$Mutation$LoginWithApple$authenticate<TRes> {
  _CopyWithImpl$Mutation$LoginWithApple$authenticate(
    this._instance,
    this._then,
  );

  final Mutation$LoginWithApple$authenticate _instance;

  final TRes Function(Mutation$LoginWithApple$authenticate) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? $__typename = _undefined}) =>
      _then(Mutation$LoginWithApple$authenticate(
          $__typename: $__typename == _undefined || $__typename == null
              ? _instance.$__typename
              : ($__typename as String)));
}

class _CopyWithStubImpl$Mutation$LoginWithApple$authenticate<TRes>
    implements CopyWith$Mutation$LoginWithApple$authenticate<TRes> {
  _CopyWithStubImpl$Mutation$LoginWithApple$authenticate(this._res);
...
class Mutation$LoginWithApple$authenticate$$CurrentUser
    implements Mutation$LoginWithApple$authenticate {
  Mutation$LoginWithApple$authenticate$$CurrentUser({
    required this.id,
    required this.identifier,
    this.$__typename = 'CurrentUser',
  });

  factory Mutation$LoginWithApple$authenticate$$CurrentUser.fromJson(
      Map<String, dynamic> json) {
    final l$id = json['id'];
    final l$identifier = json['identifier'];
    final l$$__typename = json['__typename'];
    return Mutation$LoginWithApple$authenticate$$CurrentUser(
      id: (l$id as String),
      identifier: (l$identifier as String),
      $__typename: (l$$__typename as String),
    );
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$LoginWithApple$authenticate$$CurrentUser ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Mutation$LoginWithApple$authenticate$$CurrentUser
    on Mutation$LoginWithApple$authenticate$$CurrentUser {
  CopyWith$Mutation$LoginWithApple$authenticate$$CurrentUser<
          Mutation$LoginWithApple$authenticate$$CurrentUser>
      get copyWith =>
          CopyWith$Mutation$LoginWithApple$authenticate$$CurrentUser(
            this,
...
abstract class CopyWith$Mutation$LoginWithApple$authenticate$$CurrentUser<
    TRes> {
  factory CopyWith$Mutation$LoginWithApple$authenticate$$CurrentUser(
    Mutation$LoginWithApple$authenticate$$CurrentUser instance,
    TRes Function(Mutation$LoginWithApple$authenticate$$CurrentUser) then,
  ) = _CopyWithImpl$Mutation$LoginWithApple$authenticate$$CurrentUser;

  factory CopyWith$Mutation$LoginWithApple$authenticate$$CurrentUser.stub(
          TRes res) =
      _CopyWithStubImpl$Mutation$LoginWithApple$authenticate$$CurrentUser;
...
class _CopyWithImpl$Mutation$LoginWithApple$authenticate$$CurrentUser<TRes>
    implements
        CopyWith$Mutation$LoginWithApple$authenticate$$CurrentUser<TRes> {
  _CopyWithImpl$Mutation$LoginWithApple$authenticate$$CurrentUser(
    this._instance,
    this._then,
  );

  final Mutation$LoginWithApple$authenticate$$CurrentUser _instance;

  final TRes Function(Mutation$LoginWithApple$authenticate$$CurrentUser) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$LoginWithApple$authenticate$$CurrentUser(
        id: id == _undefined || id == null ? _instance.id : (id as String),
        identifier: identifier == _undefined || identifier == null
            ? _instance.identifier
            : (identifier as String),
...
class _CopyWithStubImpl$Mutation$LoginWithApple$authenticate$$CurrentUser<TRes>
    implements
        CopyWith$Mutation$LoginWithApple$authenticate$$CurrentUser<TRes> {
  _CopyWithStubImpl$Mutation$LoginWithApple$authenticate$$CurrentUser(
      this._res);
...
class Mutation$LoginWithApple$authenticate$$InvalidCredentialsError
    implements Mutation$LoginWithApple$authenticate {
  Mutation$LoginWithApple$authenticate$$InvalidCredentialsError({
    required this.message,
    this.$__typename = 'InvalidCredentialsError',
  ...
  factory Mutation$LoginWithApple$authenticate$$InvalidCredentialsError.fromJson(
      Map<String, dynamic> json) {
    final l$message = json['message'];
    final l$$__typename = json['__typename'];
    return Mutation$LoginWithApple$authenticate$$InvalidCredentialsError(
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Mutation$LoginWithApple$authenticate$$InvalidCredentialsError ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$message = message;
...
extension UtilityExtension$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError
    on Mutation$LoginWithApple$authenticate$$InvalidCredentialsError {
  CopyWith$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError<
          Mutation$LoginWithApple$authenticate$$InvalidCredentialsError>
      get copyWith =>
          CopyWith$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError(
            this,
...
abstract class CopyWith$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError<
    TRes> {
  factory CopyWith$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError(
    Mutation$LoginWithApple$authenticate$$InvalidCredentialsError instance,
    TRes Function(Mutation$LoginWithApple$authenticate$$InvalidCredentialsError)
        then,
  ) = _CopyWithImpl$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError;

  factory CopyWith$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError.stub(
          TRes res) =
      _CopyWithStubImpl$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError;
...
class _CopyWithImpl$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError<
        TRes>
    implements
        CopyWith$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError<
            TRes> {
  ...
  final Mutation$LoginWithApple$authenticate$$InvalidCredentialsError _instance;

  final TRes Function(
      Mutation$LoginWithApple$authenticate$$InvalidCredentialsError) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$LoginWithApple$authenticate$$InvalidCredentialsError(
        message: message == _undefined || message == null
            ? _instance.message
            : (message as String),
        $__typename: $__typename == _undefined || $__typename == null
...
class _CopyWithStubImpl$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError<
        TRes>
    implements
        CopyWith$Mutation$LoginWithApple$authenticate$$InvalidCredentialsError<
            TRes> {
...
class Mutation$LoginWithApple$authenticate$$NotVerifiedError
    implements Mutation$LoginWithApple$authenticate {
  Mutation$LoginWithApple$authenticate$$NotVerifiedError({
    required this.message,
    this.$__typename = 'NotVerifiedError',
  });

  factory Mutation$LoginWithApple$authenticate$$NotVerifiedError.fromJson(
      Map<String, dynamic> json) {
    final l$message = json['message'];
    final l$$__typename = json['__typename'];
    return Mutation$LoginWithApple$authenticate$$NotVerifiedError(
      message: (l$message as String),
      $__typename: (l$$__typename as String),
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$LoginWithApple$authenticate$$NotVerifiedError ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$message = message;
...
extension UtilityExtension$Mutation$LoginWithApple$authenticate$$NotVerifiedError
    on Mutation$LoginWithApple$authenticate$$NotVerifiedError {
  CopyWith$Mutation$LoginWithApple$authenticate$$NotVerifiedError<
          Mutation$LoginWithApple$authenticate$$NotVerifiedError>
      get copyWith =>
          CopyWith$Mutation$LoginWithApple$authenticate$$NotVerifiedError(
            this,
...
abstract class CopyWith$Mutation$LoginWithApple$authenticate$$NotVerifiedError<
    TRes> {
  factory CopyWith$Mutation$LoginWithApple$authenticate$$NotVerifiedError(
    Mutation$LoginWithApple$authenticate$$NotVerifiedError instance,
    TRes Function(Mutation$LoginWithApple$authenticate$$NotVerifiedError) then,
  ) = _CopyWithImpl$Mutation$LoginWithApple$authenticate$$NotVerifiedError;

  factory CopyWith$Mutation$LoginWithApple$authenticate$$NotVerifiedError.stub(
          TRes res) =
      _CopyWithStubImpl$Mutation$LoginWithApple$authenticate$$NotVerifiedError;
...
class _CopyWithImpl$Mutation$LoginWithApple$authenticate$$NotVerifiedError<TRes>
    implements
        CopyWith$Mutation$LoginWithApple$authenticate$$NotVerifiedError<TRes> {
  _CopyWithImpl$Mutation$LoginWithApple$authenticate$$NotVerifiedError(
    this._instance,
    this._then,
  );

  final Mutation$LoginWithApple$authenticate$$NotVerifiedError _instance;

  final TRes Function(Mutation$LoginWithApple$authenticate$$NotVerifiedError)
      _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$LoginWithApple$authenticate$$NotVerifiedError(
        message: message == _undefined || message == null
            ? _instance.message
            : (message as String),
        $__typename: $__typename == _undefined || $__typename == null
...
class _CopyWithStubImpl$Mutation$LoginWithApple$authenticate$$NotVerifiedError<
        TRes>
    implements
        CopyWith$Mutation$LoginWithApple$authenticate$$NotVerifiedError<TRes> {
  _CopyWithStubImpl$Mutation$LoginWithApple$authenticate$$NotVerifiedError(
