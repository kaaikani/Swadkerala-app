...
class Query$Getappupdate {
  Query$Getappupdate({
    this.getUpdateInfoForChannel,
    this.$__typename = 'Query',
  });

  factory Query$Getappupdate.fromJson(Map<String, dynamic> json) {
    final l$getUpdateInfoForChannel = json['getUpdateInfoForChannel'];
    final l$$__typename = json['__typename'];
    return Query$Getappupdate(
      getUpdateInfoForChannel: l$getUpdateInfoForChannel == null
          ? null
          : Query$Getappupdate$getUpdateInfoForChannel.fromJson(
              (l$getUpdateInfoForChannel as Map<String, dynamic>)),
      $__typename: (l$$__typename as String),
    );
  }

  final Query$Getappupdate$getUpdateInfoForChannel? getUpdateInfoForChannel;

  final String $__typename;

  Map<String, dynamic> toJson() {
    final _resultData = <String, dynamic>{};
    final l$getUpdateInfoForChannel = getUpdateInfoForChannel;
    _resultData['getUpdateInfoForChannel'] =
        l$getUpdateInfoForChannel?.toJson();
    final l$$__typename = $__typename;
    _resultData['__typename'] = l$$__typename;
    return _resultData;
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Getappupdate || runtimeType != other.runtimeType) {
      return false;
    }
    final l$getUpdateInfoForChannel = getUpdateInfoForChannel;
    final lOther$getUpdateInfoForChannel = other.getUpdateInfoForChannel;
    if (l$getUpdateInfoForChannel != lOther$getUpdateInfoForChannel) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
extension UtilityExtension$Query$Getappupdate on Query$Getappupdate {
  CopyWith$Query$Getappupdate<Query$Getappupdate> get copyWith =>
      CopyWith$Query$Getappupdate(
        this,
        (i) => i,
      );
}

abstract class CopyWith$Query$Getappupdate<TRes> {
  factory CopyWith$Query$Getappupdate(
    Query$Getappupdate instance,
    TRes Function(Query$Getappupdate) then,
  ) = _CopyWithImpl$Query$Getappupdate;

  factory CopyWith$Query$Getappupdate.stub(TRes res) =
      _CopyWithStubImpl$Query$Getappupdate;

  TRes call({
    Query$Getappupdate$getUpdateInfoForChannel? getUpdateInfoForChannel,
    String? $__typename,
  });
  CopyWith$Query$Getappupdate$getUpdateInfoForChannel<TRes>
      get getUpdateInfoForChannel;
}

class _CopyWithImpl$Query$Getappupdate<TRes>
    implements CopyWith$Query$Getappupdate<TRes> {
  _CopyWithImpl$Query$Getappupdate(
    this._instance,
    this._then,
  );

  final Query$Getappupdate _instance;

  final TRes Function(Query$Getappupdate) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({
    Object? getUpdateInfoForChannel = _undefined,
    Object? $__typename = _undefined,
  }) =>
      _then(Query$Getappupdate(
        getUpdateInfoForChannel: getUpdateInfoForChannel == _undefined
            ? _instance.getUpdateInfoForChannel
            : (getUpdateInfoForChannel
                as Query$Getappupdate$getUpdateInfoForChannel?),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
  ...
  CopyWith$Query$Getappupdate$getUpdateInfoForChannel<TRes>
      get getUpdateInfoForChannel {
    final local$getUpdateInfoForChannel = _instance.getUpdateInfoForChannel;
    return local$getUpdateInfoForChannel == null
        ? CopyWith$Query$Getappupdate$getUpdateInfoForChannel.stub(
            _then(_instance))
        : CopyWith$Query$Getappupdate$getUpdateInfoForChannel(
            local$getUpdateInfoForChannel,
            (e) => call(getUpdateInfoForChannel: e));
  }
}

class _CopyWithStubImpl$Query$Getappupdate<TRes>
    implements CopyWith$Query$Getappupdate<TRes> {
  _CopyWithStubImpl$Query$Getappupdate(this._res);
  ...
  CopyWith$Query$Getappupdate$getUpdateInfoForChannel<TRes>
      get getUpdateInfoForChannel =>
          CopyWith$Query$Getappupdate$getUpdateInfoForChannel.stub(_res);
}

const documentNodeQueryGetappupdate = DocumentNode(definitions: [
  OperationDefinitionNode(
    type: OperationType.query,
    name: NameNode(value: 'Getappupdate'),
    variableDefinitions: [],
    directives: [],
    selectionSet: SelectionSetNode(selections: [
      FieldNode(
        name: NameNode(value: 'getUpdateInfoForChannel'),
        alias: null,
        arguments: [],
        directives: [],
        selectionSet: SelectionSetNode(selections: [
          ...
          FieldNode(
            name: NameNode(value: 'updateType'),
            alias: null,
            arguments: [],
            directives: [],
            selectionSet: null,
...
Query$Getappupdate _parserFn$Query$Getappupdate(Map<String, dynamic> data) =>
    Query$Getappupdate.fromJson(data);
typedef OnQueryComplete$Query$Getappupdate = FutureOr<void> Function(
  Map<String, dynamic>?,
  Query$Getappupdate?,
);

class Options$Query$Getappupdate
    extends graphql.QueryOptions<Query$Getappupdate> {
  Options$Query$Getappupdate({
    String? operationName,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Query$Getappupdate? typedOptimisticResult,
    Duration? pollInterval,
    graphql.Context? context,
    OnQueryComplete$Query$Getappupdate? onComplete,
    graphql.OnQueryError? onError,
  })  : onCompleteWithParsed = onComplete,
        super(
          operationName: operationName,
          ...
          onComplete: onComplete == null
              ...
              : (data) => onComplete(
                    data,
                    data == null ? null : _parserFn$Query$Getappupdate(data),
                  ),
          onError: onError,
          document: documentNodeQueryGetappupdate,
          parserFn: _parserFn$Query$Getappupdate,
        );

  final OnQueryComplete$Query$Getappupdate? onCompleteWithParsed;
...
class WatchOptions$Query$Getappupdate
    extends graphql.WatchQueryOptions<Query$Getappupdate> {
  WatchOptions$Query$Getappupdate({
    String? operationName,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
...
class FetchMoreOptions$Query$Getappupdate extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$Getappupdate(
      {required graphql.UpdateQuery updateQuery})
      : super(
          updateQuery: updateQuery,
          document: documentNodeQueryGetappupdate,
...
extension ClientExtension$Query$Getappupdate on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$Getappupdate>> query$Getappupdate(
          [Options$Query$Getappupdate? options]) async =>
      await this.query(options ?? Options$Query$Getappupdate());
  graphql.ObservableQuery<Query$Getappupdate> watchQuery$Getappupdate(
          [WatchOptions$Query$Getappupdate? options]) =>
      this.watchQuery(options ?? WatchOptions$Query$Getappupdate());
  void writeQuery$Getappupdate({
    required Query$Getappupdate data,
    bool broadcast = true,
  }) =>
      this.writeQuery(
        graphql.Request(
            operation:
                graphql.Operation(document: documentNodeQueryGetappupdate)),
        data: data.toJson(),
        broadcast: broadcast,
      );
  Query$Getappupdate? readQuery$Getappupdate({bool optimistic = true}) {
    final result = this.readQuery(
      graphql.Request(
          operation:
              graphql.Operation(document: documentNodeQueryGetappupdate)),
    ...
    return result == null ? null : Query$Getappupdate.fromJson(result);
  }
}

graphql_flutter.QueryHookResult<Query$Getappupdate> useQuery$Getappupdate(
        [Options$Query$Getappupdate? options]) =>
    graphql_flutter.useQuery(options ?? Options$Query$Getappupdate());
graphql.ObservableQuery<Query$Getappupdate> useWatchQuery$Getappupdate(
        [WatchOptions$Query$Getappupdate? options]) =>
    graphql_flutter.useWatchQuery(options ?? WatchOptions$Query$Getappupdate());

class Query$Getappupdate$Widget
    extends graphql_flutter.Query<Query$Getappupdate> {
  Query$Getappupdate$Widget({
    widgets.Key? key,
    Options$Query$Getappupdate? options,
    required graphql_flutter.QueryBuilder<Query$Getappupdate> builder,
  }) : super(
          key: key,
          options: options ?? Options$Query$Getappupdate(),
          builder: builder,
        );
}

class Query$Getappupdate$getUpdateInfoForChannel {
  Query$Getappupdate$getUpdateInfoForChannel({
    required this.latestVersion,
    required this.updateType,
    this.$__typename = 'UpdateInfo',
  });

  factory Query$Getappupdate$getUpdateInfoForChannel.fromJson(
      Map<String, dynamic> json) {
    final l$latestVersion = json['latestVersion'];
    final l$updateType = json['updateType'];
    final l$$__typename = json['__typename'];
    return Query$Getappupdate$getUpdateInfoForChannel(
      latestVersion: (l$latestVersion as String),
      updateType: (l$updateType as String),
      $__typename: (l$$__typename as String),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _resultData['latestVersion'] = l$latestVersion;
    final l$updateType = updateType;
    _resultData['updateType'] = l$updateType;
    final l$$__typename = $__typename;
    _resultData['__typename'] = l$$__typename;
    return _resultData;
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Getappupdate$getUpdateInfoForChannel ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$latestVersion = latestVersion;
    ...
    final l$updateType = updateType;
    final lOther$updateType = other.updateType;
    if (l$updateType != lOther$updateType) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
extension UtilityExtension$Query$Getappupdate$getUpdateInfoForChannel
    on Query$Getappupdate$getUpdateInfoForChannel {
  CopyWith$Query$Getappupdate$getUpdateInfoForChannel<
          Query$Getappupdate$getUpdateInfoForChannel>
      get copyWith => CopyWith$Query$Getappupdate$getUpdateInfoForChannel(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Query$Getappupdate$getUpdateInfoForChannel<TRes> {
  factory CopyWith$Query$Getappupdate$getUpdateInfoForChannel(
    Query$Getappupdate$getUpdateInfoForChannel instance,
    TRes Function(Query$Getappupdate$getUpdateInfoForChannel) then,
  ) = _CopyWithImpl$Query$Getappupdate$getUpdateInfoForChannel;

  factory CopyWith$Query$Getappupdate$getUpdateInfoForChannel.stub(TRes res) =
      _CopyWithStubImpl$Query$Getappupdate$getUpdateInfoForChannel;
...
class _CopyWithImpl$Query$Getappupdate$getUpdateInfoForChannel<TRes>
    implements CopyWith$Query$Getappupdate$getUpdateInfoForChannel<TRes> {
  _CopyWithImpl$Query$Getappupdate$getUpdateInfoForChannel(
    this._instance,
    this._then,
  );

  final Query$Getappupdate$getUpdateInfoForChannel _instance;

  final TRes Function(Query$Getappupdate$getUpdateInfoForChannel) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Query$Getappupdate$getUpdateInfoForChannel(
        latestVersion: latestVersion == _undefined || latestVersion == null
            ? _instance.latestVersion
            : (latestVersion as String),
        updateType: updateType == _undefined || updateType == null
            ? _instance.updateType
...
class _CopyWithStubImpl$Query$Getappupdate$getUpdateInfoForChannel<TRes>
    implements CopyWith$Query$Getappupdate$getUpdateInfoForChannel<TRes> {
  _CopyWithStubImpl$Query$Getappupdate$getUpdateInfoForChannel(this._res);
